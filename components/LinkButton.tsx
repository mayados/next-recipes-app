...
const LinkButton:React.FC<LinkButtonProps> = ({label, icon: Icon, actionButton, path, dynamicPath}) => {
  return (
    <Link href={`${path}${dynamicPath}`} className='inline-flex items-center px-3 py-2 mt-3 bg-cyan-900 hover:bg-cyan-800 cursor-pointer rounded-lg' onClick={actionButton}>
