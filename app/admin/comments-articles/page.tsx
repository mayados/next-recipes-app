...
const CommentArticles = () =>{
    ...
    const [comments, setComments] = useState<CommentArticle[]>([])
    const [commentToDelete, setCommentToDelete] = useState<string | null>(null); 
    let [isOpen, setIsOpen] = useState(false);

    useEffect(() => {
        const fetchComments = async () => {
          const response = await fetch(`/api/admin/comments/comments-articles`)
    ...
    <div className="flex w-screen">
      ...
      <AdminNav />
        <section className="border-2 border-green-800 flex-[8]">
            <h1 className="text-3xl text-white text-center">Comments articles</h1>
